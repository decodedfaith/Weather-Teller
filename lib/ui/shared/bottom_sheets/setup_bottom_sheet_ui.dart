...
import 'package:weather_test/ui/shared/bottom_sheets/locations_serch_bottomsheet/locations_search_bottomsheet_view.dart';
...
void setupBottomSheetUi() {
  ...
  final builders = {
    ...
    BottomSheetType.locationSearch: (
      context,
      sheetRequest,
      completer,
    ) =>
